...
const Page = () => {
    ...
    }, [user]); // Met à jour isUserLoaded quand user change

    useEffect(() => {
        if (isUserLoaded && searchParams) {
    ...
    }, [isUserLoaded, searchParams, user]); // Dépendances mises à jour pour attendre isUserLoaded
