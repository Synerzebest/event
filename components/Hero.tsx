...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative top-24 sm:top-12 z-10 text-center p-4 sm:p-8 flex flex-col justify-center items-center gap-4 lg:text-left">
      <h1 className="text-4xl text-white text-center sm:text-5xl md:text-6xl font-bold w-full break-words">
        ...
        <div className="mt-36 sm:mt-24 flex flex-col sm:flex-row items-center gap-4">
